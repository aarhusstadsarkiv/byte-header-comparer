...
#filenames: list[Path] = [Path('1st_file.bin'), Path('2nd_file.bin'), Path('3rd_file.bin')]
...
def test_rotate_filenames():
    filenames: list[Path] = [Path('tests/1st_file.bin'), Path('tests/2nd_file.bin'), Path('tests/3rd_file.bin')]
