...
@click.option("-f", "--folder", "folder", help="Folder of files to compare.")
@click.option("-hs", "--header_size", "header_size", default=1024, help="Optional size of header to compare.")
@click.pass_context
